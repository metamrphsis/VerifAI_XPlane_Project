...
os.chdir('/Users/fdup/VerifAI_XPlane_Project/dev/scripts')
...
if __name__ == '__main__':
    ...
    parser.add_argument('-c', '--config', help='experiment configuration file', default='../configs/config.yaml')
    parser.add_argument('-r', '--runway', help='runway configuration file', default='../configs/runway.yaml')
